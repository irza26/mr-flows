...
export default function LoginAdmin({ setView }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Menyimpan data user (bisa admin atau umum) ke localStorage
        ...
        <div style={formWrapperStyle}>
          ...
          <form style={{ marginTop: '30px' }} onSubmit={handleLogin}>
            ...
            <div style={formExtraStyle}>
              {/* Bagian "Ingat saya" dihapus, hanya menyisakan Lupa Password */}
              <div /> 
              <span style={{ color: '#00a8ff', fontWeight: '500', cursor: 'pointer', fontSize: '13px' }}>
                Lupa password?
              </span>
            </div>
...
const formExtraStyle = { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' };
